...
export default function Element6Layout({ children }: { children: ReactNode }) {
  ...
  const activeSubsection = subsectionMatch ? subsectionMatch[1] : '6.1';

  const elementTitle = 'Element 6 Transfer Completion ';
  const currentElementNumber = 6;
  ...
  const isLastSubsection = activeSubsection === '6.1';
