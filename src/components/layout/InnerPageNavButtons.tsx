...
const elementMap = [
  { element: 1, path: '/doc/six-core-elements/element-1', firstSubsection: '1.1' },
  { element: 2, path: '/doc/six-core-elements/element-2', firstSubsection: '2.1' },
  { element: 3, path: '/doc/six-core-elements/element-3', firstSubsection: '3.1' },
  { element: 4, path: '/doc/six-core-elements/element-4', firstSubsection: '4.1' },
  { element: 5, path: '/doc/six-core-elements/element-5', firstSubsection: '5.1' },
  { element: 6, path: '/doc/six-core-elements/element-6', firstSubsection: '6.1' },
];
...
export default function InnerPageNavButtons({ prevSection, nextSection, currentElementNumber, isLastSubsection }: InnerPageNavButtonsProps) {
  ...
  return (
    ...
    >
      ...
      {prevSection ? (
        <Link
          href={`/doc/six-core-elements/element-${currentElementNumber}/e${prevSection.id}`}
        ...
        <Link href='/doc/six-core-elements' className='flex items-center font-roboto text-[16px] leading-[25px] hover:opacity-70'>
          <ArrowLeft className='mr-2 flex-shrink-0' />
      ...
      {nextSection && !isLastSubsection ? (
        <Link
          href={`/doc/six-core-elements/element-${currentElementNumber}/e${nextSection.id}`}
