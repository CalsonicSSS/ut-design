...
export default function SuggestedCitationContent() {
  return (
    <section className='py-10 doc-content-text'>
      ...
      <p className='mb-6'>
        Cleverley et al. (2025). The UNITE Guidebook: Core Components of CAMHS to AMHS Transitions. University of Toronto. Retrieved from {'https://cleverleylab.com/unite-toolkit'}
      </p>
